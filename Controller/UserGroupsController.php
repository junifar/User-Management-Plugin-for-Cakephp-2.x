...
class UserGroupsController extends UserMgmtAppController
{
	...
	/*
		Function-index()
		Arguments-
		Description- Used to view all groups by Admin
	*/
	...
	/*
		Function-addGroup()
		Arguments-
		Description- Used to add group on the site by Admin
	*/
	...
	/*
		...
		Arguments- 
		@groupId- group id
		Description- Used to edit group on the site by Admin
	*/
	...
	/*
		...
		Arguments- 
		@groupId- group id
		Description- Used to delete group on the site by Admin
	*/
