...
class UsersController extends UserMgmtAppController
{
	...
	/*
		Function-index()
		Arguments-
		Description- Used to display all users by Admin
	*/
	...
	/*
		Function-viewUser()
		Arguments-
		@userId- user id for user
		Description- Used to display detail of user by Admin
	*/
	...
	/*
		Function-myprofile()
		Arguments-
		Description- Used to display detail of user by user
	*/
	...
	/*
		Function-login()
		Arguments-
		Description- Used to logged in the site 
	*/
	...
	/*
		Function-logout()
		Arguments-
		Description- Used to logged out from the site 
	*/
	...
	/*
		Function-register()
		Arguments-
		Description- Used to register on the site 
	*/
		...
		if(siteRegistration)
		{
			...
			if ($this->request -> isPost())
			{
				...
				if($this->User->RegisterValidate())
				{
					...
					else if(!$this->UserGroup->isAllowedForRegistration($this->data['User']['user_group_id']))
					{
	...
	/*
		...
		Arguments-
		Description- Used to change the password by user
	*/
	...
	/*
		...
		Description- Used to change the user password by Admin
	*/
	...
	/*
		Function-addUser()
		Arguments-
		Description- Used to add user on the site by Admin
	*/
	...
	/*
		...
		Arguments-
		@userId- user id of user
		Description- Used to edit user on the site by Admin
	*/
	...
	/*
		...
		Arguments-
		@userId- user id of user
		Description- Used to delete the user by Admin
	*/
	...
	/*
		Function-dashboard()
		Arguments-
		Description- Used to show dashboard of the user 
	*/
	...
	/*
		...
		Arguments-
		@userId- user id of user
		Description- Used to activate user by Admin
	*/
	...
	/*
		...
		Arguments-
		Description- Used to show access denied page if user want to view the page without permission
	*/
	...
	/*
		...
		Arguments-
		Description- Used to verify user's email address
	*/
	...
	*/
	...
	/*
		...
		Arguments-
		Description- Used to reset password when user comes on the by clicking the password reset link from their email.
	*/
